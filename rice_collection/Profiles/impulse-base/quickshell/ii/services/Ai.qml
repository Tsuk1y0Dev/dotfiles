...
Singleton {
	...
	"openrouter-deepseek-chimera": aiModelComponent.createObject(this, {
   		 "name": "TngTech: DeepSeek Chimera",
   		 "icon": "deepseek-symbolic",  // Нужно создать .svg иконку
    		"description": Translation.tr("🔥 Мультимодальная TngTech модель с поддержкой 128k контекста\nИспользует OpenRouter - возможен расход кредитов"),
    		"homepage": "https://tngtech.com/deepseek-chimera",
    		"endpoint": "https://openrouter.ai/api/v1/chat/completions",
    		"model": "tngtech/deepseek-r1t-chimera:free",  // Проверьте точный ID в OpenRouter!
    		"requires_key": true,
    		"key_id": "openrouter",  // Используем тот же ключ, что и для R1
    		"key_get_link": "https://openrouter.ai/settings/keys",
    		"key_get_description": Translation.tr("Требуются кредиты OpenRouter: см. https://openrouter.ai/credits\n\nСоздайте ключ в OpenRouter → Keys"),
    		"api_format": "openai"  // Формат тот же, что у других моделей
	}),
    }
